...
All art assets are stored in **resources/images**.
Images should be saved into the appropriate folder in SVG format (except the **splash** folder, these are JPEGs). SVGs should have an aspect ratio with the same width and height.
...
In the **resources/words** folder, the following folders contain word lists used by the program.
