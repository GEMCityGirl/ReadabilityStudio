...
The documentation is stored in **bookdown** projects in the **readability-studio-manual** and **readability-studio-api** folders. The markdown files (\*.Rmd) can be edited in **RStudio**.
