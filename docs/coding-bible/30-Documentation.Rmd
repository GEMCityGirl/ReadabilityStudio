...
This will generate all new screenshots in the root **docs/readability-studio-manual/images**. The subdirectory **NonGenerated** will not be effected, but does not need to be.
