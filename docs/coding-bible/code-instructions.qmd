...
- Add an XML constant tag for aformentioned variable in **src/app/readability_app_options.h**.
...
- If a ribbon button (not in the project area of the ribbon), add logic for it to be addded to the ribbon in `BatchProjectView::OnItemSelected()` in **src/projects/batch_project_view.cpp** and
