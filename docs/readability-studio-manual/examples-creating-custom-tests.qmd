...
knitr::include_graphics("images/custom-test-example1-test-name.png")
```
...
```{r echo=F, fig.align='center', out.width='100%'}
knitr::include_graphics("images/custom-test-example1-finished.png")
```
...
As described in \@ref(sec-grade-level-clamping), regression-based tests are clamped to the reasonable limit of 19^th^ grade (i.e., PhD). If you wish to override this, however, you can create a copy of a test and not set an upper limit for its score.
...
```{r echo=F, fig.align='center', out.width='100%'}
knitr::include_graphics("images/custom-testfk-unclamped.png")
```
...
```{r echo=F, fig.align='center', out.width='100%'}
knitr::include_graphics("images/custom-test-example2-name.png")
```
...
```{r echo=F, fig.align='center', out.width='100%'}
knitr::include_graphics("images/custom-test-example2-formula-finished.png")
```
...
```{r echo=F, fig.align='center', out.width='100%'}
knitr::include_graphics("images/custom-test-example2-words-loaded.png")
```
...
```{r echo=F, fig.align='center', out.width='100%'}
knitr::include_graphics("images/custom-test-example2-word-settings-finished.png")
```
...
```{r echo=F, fig.align='center', out.width='100%'}
knitr::include_graphics("images/custom-test-treat.png")
```
...
```{r echo=F, fig.align='center', out.width='100%'}
knitr::include_graphics("images/custom-index-test-example-proper-and-numerals-finished.png")
```
