...
In the next example (see @sec-external-editing), we will edit our document from another program and view the changes in *Readability Studio* in real-time.\index{editing!from \textit{Readability Studio}|)}
