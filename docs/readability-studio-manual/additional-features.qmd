...
If [file linking](#sec-options-document) is enabled, then the project will link to these local files instead of the website.
...
Refer to \@ref(sec-adding-labels-to-batch) and \@ref(sec-grouping-docs-in-batch) for examples of this feature.
