...
$if(pdf-cover-background-color)$
  \definecolor{cover-background-color}{RGB}{$pdf-cover-background-color$}
$else$
  \colorlet{cover-background-color}{white}
$endif$
...
\begin{tcolorbox}[enhanced jigsaw, sharp corners, spread outwards, grow sidewards by=5mm, enlarge top by=-2mm,
       ...
       {\covertitlefont \fontsize{42pt}{46pt} \color{cover-font-color} \textbf{$title$}}

       \vspace{.5cm}
       {\covertitlefont \fontsize{30pt}{34pt} \color{cover-font-color} \textbf{$subtitle$}\vphantom{Qy}}
...
] at (current page.south east)
{
  {\fontsize{18pt}{22pt}
   \color{author-color}
   {\usefont{T1}{qcs}{b}{sc} \capitalizetitle{$author$}}}
};
