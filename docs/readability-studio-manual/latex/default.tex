...
\begin{overpic}[clip]{$pdf-cover$}
  % title section
  \put(-1, 100)
  {
  \begin{tcolorbox}[enhanced jigsaw, sharp corners, spread outwards, grow to right by=5mm,
                    box align=top, boxsep=0.5cm, valign=top, text height=3.75cm, boxrule=0mm,
       ...
       \vspace{0.1cm}
       \tcblower
       {\large \color{black} \adforn{45}\quad\textbf{$description$}\quad\adforn{46}}
  \end{tcolorbox}
  }
  % author
  \put(-1, 0)
  ...
  \begin{tcolorbox}[enhanced jigsaw, sharp corners, box align=bottom, halign=right, boxsep=0.5cm,
                    spread outwards, grow to right by=5mm,
                    colback=cover-color, colframe=cover-color, opacityback=0.4, boxrule=0mm,
                    borderline north={1pt}{0pt}{cover-color}]
       {\fontsize{18pt}{22pt} \bfseries \color{author-color} $author$}
  \end{tcolorbox}
  }
\end{overpic}
