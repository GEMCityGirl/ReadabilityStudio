...
\definecolor{titlepagecolor}{cmyk}{.44,0,.37,.63}
...
% add the title page decoration to each part page,
% and add a message on the blank page after it
\makeatletter
...
\definecolor{ocre}{RGB}{111, 144, 132} % Define the color used for highlighting throughout the book (actually green, instead of ocre)

\chapterimage{non-generated/orange2.jpg} % Chapter heading image
