...
To draw attention to these groups of words, press the `r keys('Showcase')` on the ribbon. Now the cumulative bar group and labels will only be shown for these bars:
