## FRASE\index{FRASE|(ii} Graph {-#sec-frase}
...
This test is designed for 100-word samples, with 3 samples being recommended for best results. ([Normalization](#sec-glossary) can also be used to analyze larger samples or entire documents.)\index{FRASE|)}
