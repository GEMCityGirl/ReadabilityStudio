...
This test is designed for 100-word samples and uses the same statistics as the [Fry](#fry-test)\index{Fry} test. ([Normalization](#sec-glossary) can also be used to analyze larger samples or entire documents.)\index{Crawford|)}
