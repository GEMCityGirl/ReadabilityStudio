...
The *100+* with the arrow underneath it (to the left) indicates that the axis labels should have 100 added to them. This is done to make the labels more compact.
