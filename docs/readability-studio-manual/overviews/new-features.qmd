...
- Added Lua scripting. This allows for programming your own scripts to automate various tasks.
...
- [Typographical ligatures](#typographical-ligatures) are now converted to the regular characters.\
  For example, "ﬀ" will be imported as "f f."
...
- Images with transparency now look sharper when displayed on graphs (Windows).
