...
- [possible misspellings (English only)](#reviewing-misspellings)
...
*Readability Studio* also includes a [Dolch](#sec-reviewing-dolch) suite of statistics and graphs, which is useful for educators and writers who work with young readers. The program provides a complete breakdown of Dolch words that you are using (and not using) in your content. This enables writers to see how they can improve their Dolch practice materials. This also enables educators to determine which materials are appropriate for Dolch practice.
