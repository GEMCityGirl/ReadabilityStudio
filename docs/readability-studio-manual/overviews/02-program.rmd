...
- [wording errors and known misspellings (English only)](#reviewing-wording-errors)
...
*Readability Studio* also includes a [Dolch](#reviewing-dolch) suite of statistics and graphs, which is useful for educators and writers who work with young readers. The program provides a complete breakdown of Dolch words that you are using (and not using) in your content. This enables writers to see how they can improve their Dolch practice materials. This also enables educators to determine which materials are appropriate for Dolch practice.
...
For example, you can specify how numeric words (e.g., *10/31/1974*) are [syllabized](#document-analysis).
