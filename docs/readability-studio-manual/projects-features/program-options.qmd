...
**Stipple image**: Enter into this field the file path to the image used for a stipple brush. A stipple brush can be used to draw stacked images across [bars and boxes](#sec-options-graphs).

**Stipple shape**: Select from here which shape to use for a stipple brush. A stipple brush can be used to draw stacked shape across [bars and boxes](#sec-options-graphs).
