...
Click the `r keys("Watermark")` button in the **Edit** section.
...
Refer to @sec-options-graphs for other watermark options.
:::
...
If the image is larger than the bars' width, then it will be scaled downed to fit.
