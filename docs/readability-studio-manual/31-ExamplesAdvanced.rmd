...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/non-generated/PeterRabbitBrowser.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/PeterRabbitChainedSentences.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/non-generated/YAEnterpriseSoftwareSymposium.png")
```
