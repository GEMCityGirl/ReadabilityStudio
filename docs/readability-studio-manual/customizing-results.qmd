...
The options made available will be dependent on the graph type. Refer to \@ref(sec-options-graphs) for further discussions of these options.

Refer to \@ref(customizing-graphs) for step-by-step tutorials on editing graphs.
