...
knitr::include_graphics("images/example-graph-default.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-graph-sorted.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-barchart-orientation-changed.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-barchart-effects-changed.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-barchart-no-labels-changed.png")
```
:::
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-graph-background-color-changed.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-graph-background-image-changed.png")
```
:::
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-graph-background-image-effect-changed.png")
```
...
Next, let's put a [watermark](#sec-watermark-and-logo) across our graph. Click the `r keys("Watermark")` button in the **Edit** section.
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-watermark-changed.png")
```

::: {.tipsection data-latex=""}
Entering `@DATE@` in the watermark field will show the current date when the graph is rendered. Refer to \@ref(sec-options-graphs) for other watermark options.
:::
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-logo-changed.png")
```
:::
...
In this example, we will use stipples\index{graphs!customizing!stipples|(} for our bar charts. Basically, a stipple enables us to use stacked images or shapes to draw our bars.
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/graph-bars-rectangular.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/graph-custom-brush.png")
```
...
```{r echo=F, fig.align='center', fig.cap="Newspapers used to draw bars", out.width='75%'}
knitr::include_graphics("images/graph-stipple-shape.png")
```

```{r echo=F, fig.align='center', fig.cap="Cars (specifically, a 2006 Scion xB) used to draw bars", out.width='75%'}
knitr::include_graphics("images/graph-stipple-shape-car.png")
```
...
In this example\index{graphs!customizing!backgrounds|(}, we will create a bar chart with a selective colorization effect. This technique is where the background is black & white and various focal points (i.e., the bars) are in color.
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-barchart-common-image.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-graph-background-image-for-common-image.png")
```
:::
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-graph-background-image-effect-grayscaled.png")
```
:::
\index{graphs!customizing!backgrounds|)}
...
Next, we will remove any visual effect from the bars. On the **Home** tab, click `r menu(c('Bar Style', 'Solid'))`. Then, click `r menu(c('Bar Style', 'Color...'))` and select a light gray.

Next, click the `r keys("Font")` button and select `r menu(c('X Axis...'))`. When the font selection dialog appears, choose a monospace font (e.g., Consolas or Courier New) and click `r keys("OK")`.
Do the same for  `r menu(c('Font', 'Y Axis...'))` and `r menu(c('Font', 'Top Titles...'))`. Doing this will give a typewriter look to the graph's text.

Once we are done, our bar chart will have a simpler, "retro" look:

```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/example-graph-retro.png")
```
