...
Coleman and Liau noted the difficulties of using computers to count syllables [-@{coleman-liau}283] for readability formulas.
As a solution, they presented a new formula that used character counts as an alternative to syllable counting.
This formula was derived from a regression equation trained on the 36 150-word passages from the Miller and Coleman cloze study [-@{miller-coleman}851]. During validation, the factors of sentences and characters per 100 words yielded a strong correlation of $r^2 = .92$ against Miller and Coleman’s cloze scores.
...
For this reason, "$(E/100)$" is shown in the second equation, rather than just "estimated cloze %" as it appears in the source article.
As an example, an estimated cloze % of 51.3 should yield a grade level of 9:
