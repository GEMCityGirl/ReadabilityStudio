...
To include this list as part of your New Dale-Chall scoring, select the **Tools** tab and click the {keys("Options")} button to display the [**Options**](#sec-options-overview) dialog. Next, expand **Readability Scores**, select **Test Options**, and then check **Include Stocker\'s Catholic supplement**. After selecting this option, all New Dale-Chall tests performed in new projects will include this supplement.')
```
