## Flesch Reading Ease\index{Flesch Reading Ease|(ii} {-#sec-flesch-test}
...
OptionsDesc <- "This behavior can be changed from the [**Options**](#sec-readability-test-options) dialog."
