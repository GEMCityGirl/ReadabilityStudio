## New Dale-Chall\index{New Dale-Chall|(ii} {-#sec-dale-chall-test}
...
- The [first instance of any proper noun](#sec-options-dale-chall)—all subsequent occurrences are considered familiar.
- All numerals.\index{numerals!New Dale-Chall}

::: {.notesection data-latex=""}
```{r, results='asis', eval=T, echo=F}
OptionsDesc <- "The default [text exclusion](#sec-options-text-exclusion) method\\index{text exclusion!New Dale-Chall} will be overridden for this specific test, although this behavior can be customized from the [**Options**](#sec-readability-test-options) dialog."
