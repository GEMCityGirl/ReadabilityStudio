...
The Farr-Jenkins-Paterson\index{Flesch Reading Ease!derivatives!Farr-Jenkins-Paterson} readability formula [-@{farr-jenkins-paterson}333–37] calculates the [Flesch](#sec-flesch-test) difficulty level of a document based on sentence length and number of monosyllabic words.
