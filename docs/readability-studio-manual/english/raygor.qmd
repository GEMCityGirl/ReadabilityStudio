## Raygor Estimate Graph\index{Raygor Estimate|(ii} {#sec-raygor-test}
...
This test is designed for three 100-word samples, with three samples being recommended for best results. ([Normalization](#sec-glossary) can also be used to analyze larger samples or entire documents.)
