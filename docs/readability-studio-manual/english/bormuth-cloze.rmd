...
The Bormuth Cloze\index{cloze} Mean (Machine Computation for Passage Readability) Formula [-@{bormuth:1966}79–132] calculates a [predicted cloze score](#cloze) for a document.
