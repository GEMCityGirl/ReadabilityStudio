...
- [Highlighted text](#sec-text-window-export): `r glue(if_else(IncludeLinux, "HTML, RTF, and Pango (Παν語) (Pango is only available on Linux.)", "HTML and RTF"))`
- Statistic summaries: HTML
- [Test results](#sec-scores-export): HTML
- Word, phrase, and sentence [lists](#sec-export-list): HTML, Text, and `r latex_logo(FALSE)`
...
Refer to \@ref(sec-how-text-is-excluded) to learn how *Readability Studio* automatically filters documents.
