...
**Stipple image**: Enter into this field the file path to the image used for a stipple brush. A stipple brush can be used to draw stacked images across [bars](#options-bar-charts) and [boxes](#options-box-plots).

**Stipple shape**: Select from here which shape to use for a stipple brush. A stipple brush can be used to draw stacked shape across [bars](#options-bar-charts) and [boxes](#options-box-plots).
...
**Stipple image**: Select this option to draw a stack of images across your bars. The image for this brush is specified on the [**General**](#options-graphs) page.

**Stipple shape**: Select this option to draw a shape across your bars. The shape for this brush is specified on the [**General**](#options-graphs) page.
...
**Stipple image**: Select this option to draw a stack of images across your boxes. The image for this brush is specified on the [**General**](#options-graphs) page.

**Stipple shape**: Select this option to draw a shape across your boxes. The shape for this brush is specified on the [**General**](#options-graphs) page.
