...
**Wording Errors & Misspellings**: Check this to include [wording errors and known misspellings](#reviewing-wording-errors) in the results.
...
**Showcase complex words**: Check this to draw attention to the complex (i.e., 3+ syllable) word groups on syllable histograms and pie charts (standard projects).
