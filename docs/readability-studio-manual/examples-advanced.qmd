...
When reviewing a document, it is usually preferable to ignore certain items, such as headers and citations (refer to \@ref(sec-how-text-is-excluded) for more information). In this example, we will discuss the various methods for excluding these items.
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-all-excluded.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-header-excluded.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-partial-excluded.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-aggressive-list.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-where-excluded.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-incomp-length-value.png")
```

Note how the *Number of characters\.\.\.* sentence is now excluded:

```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-long-sentence-excluded.png")
```

Now scroll to the bottom of the report window and note the copyright notice:

```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-copyright-included.png")
```

Go to the **Document Indexing** options, check **Also exclude copyright notices**, and click `r keys("OK")`:

```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-copyright-excluded.png")
```

Now this copyright notice will be excluded from the analysis:

```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-copyright-excluded-now.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-url-excluded.png")
```

Note how *http://www.jstor.org/* is now excluded:

```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-url-excluded-now.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-numbers-excluded-now.png")
```

Also note how proper nouns, such as *Danielson-Bryan* and *UNIVAC*, are now excluded:

```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-proper-excluded-now.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-edit-list-button.png")
```
...
knitr::include_graphics("images/exclusion-example-custom-words.png")
```

Click `r keys("OK")` and all instances of *punctuation* and *sentence length* are now excluded:

```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-custom-words-excluded-now.png")
```

Separate instances of *sentence* and *length* will still be included, they will only be excluded if they appear together to form the phrase *sentence length*. Refer to \@ref(sec-document-analysis) for more on how custom word/phrase exclusion works.
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-example-citation-excluded.png")
```
...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/exclusion-tags-example-list-excluded.png")
```
...
Continuing from the "Reviewing a Flyer" (\@ref(sec-reviewing-a-flyer)) and "High-level Review of a Disclaimer" (\@ref(sec-high-level-review-of-disclaimer)) examples, our fictitious private equity firm now plans to append a disclaimer to the flyer.
