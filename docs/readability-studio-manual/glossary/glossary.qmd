...
## Readability Terms {#sec-readability-glossary .unnumbered}
...
:::
::: {.glsdef data-latex=''}
A [cloze](#sec-cloze) procedure is a test given to readers to measure their comprehension ability. Refer to \@ref(sec-cloze) for an extended explanation.
:::
::::
...
## Statistical Terms {#sec-stat-terms .unnumbered}
...
```{r boxplot, echo=F, fig.cap="Visual of a box plot's layout, adapted from DeCicco (“Exploring ggplot2 boxplots”)", fig.align='center'}
...
knitr::include_graphics("images/non-generated/kurtosis.png")
```
:::
::::
...
knitr::include_graphics("images/non-generated/skewness.png")
```
:::
::::
