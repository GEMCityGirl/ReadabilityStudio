...
- [Mode(s)](#sec-stat-terms)\index{mode}: the most frequently occurring score.
  In the case of a tie, all modes will be listed. Note that grade scores are rounded down when searching for the mode.
...
- [Median](#sec-stat-terms)\index{median}: the middle test score.
  ...
  If the number of scores is even, then the means of the two middle points is taken.
