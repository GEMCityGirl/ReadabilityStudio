...
- **Check if ClearType is turned on.** If ClearType is turned off, then the program will ask you about enabling it. ClearType makes fonts smoother and easier to read. This applies to the Windows^®^ edition of *{{< var PROGRAM_NAME >}}* only.
...
::: {.fancyquotes data-latex=''}
{{< var PROGRAM_NAME >}} is available from *www.oleandersoftware.com*.
:::
