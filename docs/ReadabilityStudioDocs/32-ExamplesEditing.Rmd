...
The project will then analyze your changes and refresh its results.
...
For example, click `r keys("Select All")` and `r keys("Copy")`, then paste into a program such as *Microsoft Word*, *Outlook*, *Pages*, etc.
