...
Once you are finished editing your document, copy it from this editor and paste it into your publication program. For example, click `r keys("Select All")` and `r keys("Copy")`, then paste into *Microsoft Word* and save as a *Word* file.
