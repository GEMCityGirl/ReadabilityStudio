...
To go along with the watercolor bars, we could also apply an oil painting effect to the background image.
...
Click the `r keys("Background")` button and select **Image Opacity...** from the menu. On the **Set Opacity** dialog, slide the opacity down to 150. Click `r keys("OK")`.
...
Next, we will want to apply a light color to the plot area. Click the `r keys("Background")` button and select **Plot Area Color...** from the menu and select a new color (e.g., antique white).
Then, select **Opacity...** from this menu and set it to 25. Click `r keys("OK")`.

Now the plot area of the graph will have a light color applied to it:
