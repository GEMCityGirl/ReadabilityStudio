...
Continuing from our previous [example](#customizing-bars), let's now change the background of the graph.
...
::: {.minipage data-latex="{\textwidth}"}
Once we are done, our bar chart have a simpler, "retro" look:
