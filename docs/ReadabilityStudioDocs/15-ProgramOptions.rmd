...
Checking this will also cause semicolons at the end of a line to never be marked as the end of a sentence.
...
**Grouping Color Scheme**: Select from here the color scheme to apply to pie charts and grouped histograms (in batch projects).
