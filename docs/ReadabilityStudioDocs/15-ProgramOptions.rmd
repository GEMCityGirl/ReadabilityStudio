...
This is done by lowering the opacity of the bars and slices for 1- and 2-syllable word groups. Also, the labels for these simple-word slices will be hidden on the pie chart.
Note that if using a stipple shape on the syllable histogram, then this option will have no effect.
