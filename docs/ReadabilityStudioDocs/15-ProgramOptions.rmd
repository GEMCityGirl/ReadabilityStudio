...
**Stipple image**: Enter into this field the file path to the image used for a stipple brush. A stipple image can be used to draw stacked images across [bars](#options-bar-charts) and [boxes](#options-box-plots).
