...
Wheeler-Smith (Bamberger-Vanecek) [-@{bamberger-vanecek}77, 186] is a German variation of [Wheeler-Smith](#wheeler-smith) designed for both primary and secondary-age reading material. It calculates the grade level of a document based on [unit](#glossary)\index{sentences!units} length and number of complex words.
