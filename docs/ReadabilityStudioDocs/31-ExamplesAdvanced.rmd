...
```{r echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("images/NonGenerated/PeterRabbitBrowser.png")
```
...
Continuing from the "Reviewing a Flyer" (\@ref(reviewing-a-flyer)) and "High-level Review of an Disclaimer" (\@ref(high-level-review-of-disclaimer)) examples, our fictitious private equity firm now plans to append a disclaimer to the flyer.
