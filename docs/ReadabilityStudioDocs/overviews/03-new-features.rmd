...
- Aggressive exclusion will now cause semicolons at the end of a line to never be marked as the end of a sentence.
...
- Added Markdown importer. Standard Markdown and basic RMarkdown and Quarto documents are supported.
...
- File search on the batch project wizard is exponentially faster now.
