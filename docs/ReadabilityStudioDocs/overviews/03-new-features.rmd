...
- Overused Words (x Sentence) now ignores words that are part of a phrase (e.g., "*again* and *again*").
...
- **Dolch** statistics will now only be shown in the summary report if **Dolch** is included in the project.
