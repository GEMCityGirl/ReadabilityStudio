...
- **Custom Test Editor** improvements:
  - You can now edit the formula while the function browser is open.
...
- **Web Harvester** improvements:
  ...
  - Added option to send cookies defined in webpages' JavaScript code to help with connecting to pages that require JavaScript.
