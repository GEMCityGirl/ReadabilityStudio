...
glue('Although not recommended, it is possible to create a copy of any regression-based test and remove this clamping. (Refer to ch. \\@ref(custom-test-no-clamping) for an example.)')
```
