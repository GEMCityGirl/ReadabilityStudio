...
Show/hide the ribbon                    `r keys(c('Ctrl','F1'))` (`r os_logo('windows')`) or<br>\linebreak
                                        `r keys(c('\\cmd','F1'))` (`r os_logo('apple')`)
...
Save the active project                 `r keys(c('Ctrl','S'))` (`r os_logo('windows')`) or<br>\linebreak
