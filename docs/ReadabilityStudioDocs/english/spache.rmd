...
Spache recommends not counting the same unfamiliar word more than once if it appears in subsequent 100-word samples [-@{spache:1974}198]. For this reason, it is recommended to follow this practice when analyzing an entire document.
:::
