...
The Degrees of Reading Power (grade equivalent) [@{carver:1985}303–16] test calculates the difficulty level of a document by performing the [DRP](#degrees-of-reading-power) test and then converting its units score into a grade level.
