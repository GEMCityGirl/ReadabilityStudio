...
This will generate all new screenshots in the root **docs/ReadabilityStudioDocs/images**. The subdirectory **NonGenerated** will not be effected, but does not need to be. It should not contain images effected by the program's UI changes and should not contain images with content that should be localized.
...
From **RStudio**, run **docs/BuildHelpProjects.R** to build all help projects.
