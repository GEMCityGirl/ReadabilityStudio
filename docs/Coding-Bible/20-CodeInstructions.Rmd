...
- If a graphical test (e.g., **Fry**), then also do the following:
  ...
  - Update `GraphType` in API docs (**docs/ReadabilityStudioAPI/enums/GraphType.md**).
...
- Add this new enumeration value to the `ListType` in **docs/ReadabilityStudioAPI/enums/ListType.md**.
...
- Add this new enumeration value to the `HighlightedReportType` in **docs/ReadabilityStudioAPI/enums/HighlightedReportType.md**.
