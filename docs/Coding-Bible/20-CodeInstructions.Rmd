...
- Add an XML constant tag for aformentioned variable in **src/app/readability_app_options.h** (and define in **src/app/readability_app_options.cpp**).
...
- Add change watching logic for variable to `ToolsOptionsDlg::HaveXXXOptionsChanged()` (note there are different versions of these functions for each type of feature).
