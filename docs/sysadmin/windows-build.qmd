...
| :-- |
| *{{< var MIN_MSVC_REQUIRED >}}* or higher |
| *Inno Setup* |
| *R* (optional) |
| *Quarto* (optional) |
| *POEdit* (optional) |
...
- Select the "{{< var MIN_MSVC_REQUIRED >}} Release" configuration and build it
- Optionally, the "manuals" target can also be ran to rebuild the documentation

::: {.tipsection data-latex=""}
To create a debug build, select the "{{< var MIN_MSVC_REQUIRED >}} Debug" configuration.
Additionally, selecting "{{< var MIN_MSVC_REQUIRED >}} Debug w/ ASAN" will enable AddressSanitizer.
:::
