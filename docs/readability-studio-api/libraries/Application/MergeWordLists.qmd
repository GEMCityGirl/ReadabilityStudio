...
Application.MergeWordLists(
    ...
    Application.GetUserFolder(UserPath.Documents) .. "programming/csharp.txt",
    Application.GetUserFolder(UserPath.Documents) .. "programming/html.txt",
    Application.GetUserFolder(UserPath.Documents) .. "programming/java.txt",
    Application.GetUserFolder(UserPath.Documents) .. "programming/python.txt",
    Application.GetUserFolder(UserPath.Documents) .. "programming/visual-basic.txt",
...
[`MergePhraseLists()`](#mergephraselists), [`CrossReferenceWordLists()`](#crossreferencewordlists)
