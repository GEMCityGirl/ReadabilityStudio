...
Source: ..\..\docs\ReadabilityTestsReference\docs\readability-test-reference.pdf; DestDir: {app}\ReadabilityStudioDocs; Components: HelpFiles; Flags: replacesameversion restartreplace recursesubdirs
