...
# i18n summary table
string(APPEND MD "| Area | Progress | Overall |\n|---|:--:|:--:|\n")
...
string(APPEND MD "| 🧩 UI | `${_bar_ui}` | ${_emj_ui} **${_v_ui}%** |\n")
...
string(APPEND MD "| 📦 Installer | `${_bar_inst}` | ${_emj_inst} **${_v_inst}%** |\n")
...
string(APPEND MD "| 📚 Docs | `${_bar_docs}` | ${_emj_docs} **${_v_docs}%** |\n")
...
string(APPEND MD "| 🎨 Art | `${_bar_art}` | ${_emj_art} **${_v_art}%** |\n")
...
string(APPEND MD "| 📜 License | `${_bar_lic}` | ${_emj_lic} **${_v_lic}%** |\n\n")
