...
std::set<is_negating::string_type> is_negating::m_words = 
    { L"ain't", L"aren't", L"can't", L"cannot",
      ...
      L"mustn't", L"never", L"no", L"non", L"not",
      L"nowhere", L"shan't", L"wasn't", L"weren't",
      L"won't", L"wouldn't",
      // for writers with an aversion to proper punctuation *eye-roll*
      L"aint", L"arent", L"cant", L"couldnt", L"didnt", L"doesnt", L"dont",
      L"hadnt", L"hasnt", L"havent", L"isnt", L"mustnt", L"shant", L"wasnt",
      L"werent", L"wont", L"wouldnt" };
