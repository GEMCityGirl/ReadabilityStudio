...
std::set<is_contraction::string_type> is_contraction::m_s_contractions =
                    { L"anything's", L"everything's", L"it's", L"he's",
                      L"here's", L"how's", L"let's", L"she's", L"something's",
                      L"that's", L"there's", L"this's", L"what's", L"when's",
                      L"where's", L"which's", L"who's", L"why's" };
