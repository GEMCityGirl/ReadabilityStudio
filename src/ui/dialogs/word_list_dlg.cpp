...
//---------------------------------------------
void WordListDlg::AddSingleColumnPage(Wisteria::UI::SideBarBook* sideBar,
    ...
    ListCtrlEx* list =
        new ListCtrlEx(page, listId, wxDefaultPosition,
                       wxDefaultSize, wxLC_VIRTUAL|wxLC_REPORT|wxLC_ALIGN_LEFT|wxLC_NO_HEADER);
    list->SetLabel(label);
...
void WordListDlg::CreateControls()
    ...
    mainSizer->Add(searchSizer,0,wxEXPAND);
        ...
        // export
            ...
            wxRibbonPanel* exportPage =
                new wxRibbonPanel(homePage, wxID_ANY, _(L"Export"),
    ...
    // Dolch
        {
        wxPanel* page =
            new wxPanel(m_sideBar, DOLCH_PAGE_ID, wxDefaultPosition,
        ...
        ListCtrlEx* list =
            new ListCtrlEx(page, DOLCH_LIST_ID, wxDefaultPosition, wxDefaultSize,
    ...
    AddSingleColumnPage(m_sideBar, DALE_CHALL_PAGE_ID, DALE_CHALL_LIST_ID,
        _(L"New Dale-Chall"), 0, m_DCData,
        BaseProject::m_dale_chall_word_list);
    AddSingleColumnPage(m_sideBar, SPACHE_PAGE_ID, SPACHE_LIST_ID,
        _(L"Spache Revised"), 3, m_SpacheData,
        BaseProject::m_spache_word_list);
