...
private:
    static constexpr int ID_HIGHLIGHT_COLOR_BUTTON = wxID_HIGHEST + 18;
    static constexpr int ID_EXCLUDED_HIGHLIGHT_COLOR_BUTTON = wxID_HIGHEST + 19;
    static constexpr int ID_FONT_BUTTON = wxID_HIGHEST + 20;
    static constexpr int ID_DOCUMENT_STORAGE_RADIO_BOX = wxID_HIGHEST + 21;
    static constexpr int ID_FILE_BROWSE_BUTTON = wxID_HIGHEST + 22;
    static constexpr int ID_X_AXIS_FONT_BUTTON = wxID_HIGHEST + 23;
    static constexpr int ID_Y_AXIS_FONT_BUTTON = wxID_HIGHEST + 24;
    static constexpr int ID_GRAPH_TOP_TITLE_FONT_BUTTON = wxID_HIGHEST + 25;
    static constexpr int ID_GRAPH_BOTTOM_TITLE_FONT_BUTTON = wxID_HIGHEST + 26;
    static constexpr int ID_GRAPH_LEFT_TITLE_FONT_BUTTON = wxID_HIGHEST + 27;
    static constexpr int ID_GRAPH_RIGHT_TITLE_FONT_BUTTON = wxID_HIGHEST + 28;
    static constexpr int ID_PARAGRAPH_PARSE = wxID_HIGHEST + 29;
    static constexpr int ID_DUP_WORD_COLOR_BUTTON = wxID_HIGHEST + 30;
    static constexpr int ID_WORDY_PHRASE_COLOR_BUTTON = wxID_HIGHEST + 31;
    static constexpr int ID_DOLCH_CONJUNCTIONS_COLOR_BUTTON = wxID_HIGHEST + 32;
    static constexpr int ID_DOLCH_PREPOSITIONS_COLOR_BUTTON = wxID_HIGHEST + 33;
    static constexpr int ID_DOLCH_PRONOUNS_COLOR_BUTTON = wxID_HIGHEST + 34;
    static constexpr int ID_DOLCH_ADVERBS_COLOR_BUTTON = wxID_HIGHEST + 35;
    static constexpr int ID_DOLCH_ADJECTIVES_COLOR_BUTTON = wxID_HIGHEST + 36;
    static constexpr int ID_DOLCH_NOUN_COLOR_BUTTON = wxID_HIGHEST + 37;
    static constexpr int ID_EXPORT_SETTINGS_BUTTON = wxID_HIGHEST + 38;
    static constexpr int ID_LOAD_SETTINGS_BUTTON = wxID_HIGHEST + 39;
    static constexpr int ID_RESET_SETTINGS_BUTTON = wxID_HIGHEST + 40;
    static constexpr int ID_TEXT_EXCLUDE_METHOD = wxID_HIGHEST + 41;
    static constexpr int ID_SENTENCE_LONGER_THAN_BUTTON = wxID_HIGHEST + 42;
    static constexpr int ID_SENTENCE_OUTLIER_LENGTH_BUTTON = wxID_HIGHEST + 43;
    static constexpr int ID_IGNORE_BLANK_LINES_BUTTON = wxID_HIGHEST + 44;
    static constexpr int ID_IGNORE_INDENTING_BUTTON = wxID_HIGHEST + 45;
    static constexpr int ID_WARNING_MESSAGES_BUTTON = wxID_HIGHEST + 46;
    static constexpr int ID_ADD_FILE_BUTTON = wxID_HIGHEST + 47;
    static constexpr int ID_DELETE_FILE_BUTTON = wxID_HIGHEST + 48;
    static constexpr int ID_NUMBER_SYLLABIZE_METHOD = wxID_HIGHEST + 49;
    static constexpr int ID_DOLCH_VERBS_COLOR_BUTTON = wxID_HIGHEST + 50;
    static constexpr int ID_AGGRESSIVE_LIST_DEDUCTION_CHECKBOX = wxID_HIGHEST + 51;
    static constexpr int ID_EXCLUDED_PHRASES_FILE_EDIT_BUTTON = wxID_HIGHEST + 52;
    static constexpr int ID_EXCLUDE_COPYRIGHT_CHECKBOX = wxID_HIGHEST + 53;
    static constexpr int ID_EXCLUDE_CITATIONS_CHECKBOX = wxID_HIGHEST + 54;
    static constexpr int ID_EXCLUDE_FILE_ADDRESS_CHECKBOX = wxID_HIGHEST + 55;
    static constexpr int ID_EXCLUDE_NUMERALS_CHECKBOX = wxID_HIGHEST + 56;
    static constexpr int ID_EXCLUDE_PROPER_NOUNS_CHECKBOX = wxID_HIGHEST + 57;
    static constexpr int ID_INCOMPLETE_SENTENCE_VALID_VALUE_BOX = wxID_HIGHEST + 58;
    static constexpr int ID_APPLY_GRAPH_BACKGROUND_COLOR_FADE_CHECK_BOX = wxID_HIGHEST + 59;
    static constexpr int ID_GRAPH_BACKGROUND_OPACITY_SLIDER_LABEL = wxID_HIGHEST + 60;
    static constexpr int ID_GRAPH_BACKGROUND_OPACITY_SLIDER_PLUS_LABEL = wxID_HIGHEST + 61;
    static constexpr int ID_PLOT_COLOR_LABEL = wxID_HIGHEST + 62;
    static constexpr int ID_WATERMARK_LABEL = wxID_HIGHEST + 63;
    static constexpr int ID_WATERMARK_TEXT_BOX = wxID_HIGHEST + 64;
    static constexpr int ID_GRAPH_LOGO_LABEL = wxID_HIGHEST + 65;
    static constexpr int ID_BAR_CHART_EFFECTS_OPTIONS = wxID_HIGHEST + 66;
    static constexpr int ID_BAR_CHART_HORIZONTAL_OPTION = wxID_HIGHEST + 67;
    static constexpr int ID_BAR_CHART_VERTICAL_OPTION = wxID_HIGHEST + 68;
    static constexpr int ID_DOCUMENT_FONT_LABEL = wxID_HIGHEST + 69;
    static constexpr int ID_GRAPH_OPTIONS_PROPERTYGRID = wxID_HIGHEST + 70;
    static constexpr int ID_BARCHART_OPTIONS_PROPERTYGRID = wxID_HIGHEST + 71;
    static constexpr int ID_INCLUDE_FIRST_OCCURRENCE_EXCLUDE_CHECKBOX = wxID_HIGHEST + 72;
    static constexpr int ID_INCOMPLETE_SENTENCE_VALID_LABEL_START = wxID_HIGHEST + 73;
    static constexpr int ID_INCOMPLETE_SENTENCE_VALID_LABEL_END = wxID_HIGHEST + 74;
    static constexpr int ID_EXCLUSION_TAG_BLOCK_LABEL = wxID_HIGHEST + 75;
    static constexpr int ID_EXCLUSION_TAG_BLOCK_SELCTION = wxID_HIGHEST + 76;
    static constexpr int ID_ADDITIONAL_FILE_BROWSE_BUTTON = wxID_HIGHEST + 77;
    ...
    static constexpr int ID_FILE_LIST = wxID_HIGHEST + 84;
    static constexpr int ID_DOCUMENT_PATH_FIELD = wxID_HIGHEST + 85;
