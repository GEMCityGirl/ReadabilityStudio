...
private:
    ...
    static constexpr int ID_FONT_BUTTON = 1003;
    static constexpr int ID_DOCUMENT_STORAGE_RADIO_BOX = 1004;
    static constexpr int ID_FILE_BROWSE_BUTTON = 1006;
    static constexpr int ID_X_AXIS_FONT_BUTTON = 1011;
    static constexpr int ID_Y_AXIS_FONT_BUTTON = 1012;
    static constexpr int ID_GRAPH_TOP_TITLE_FONT_BUTTON = 1013;
    static constexpr int ID_GRAPH_BOTTOM_TITLE_FONT_BUTTON = 1014;
    static constexpr int ID_GRAPH_LEFT_TITLE_FONT_BUTTON = 1015;
    static constexpr int ID_GRAPH_RIGHT_TITLE_FONT_BUTTON = 1016;
    static constexpr int ID_PARAGRAPH_PARSE = 1019;
    static constexpr int ID_DUP_WORD_COLOR_BUTTON = 1023;
    static constexpr int ID_WORDY_PHRASE_COLOR_BUTTON = 1024;
    static constexpr int ID_DOLCH_CONJUNCTIONS_COLOR_BUTTON = 1025;
    static constexpr int ID_DOLCH_PREPOSITIONS_COLOR_BUTTON = 1026;
    static constexpr int ID_DOLCH_PRONOUNS_COLOR_BUTTON = 1027;
    static constexpr int ID_DOLCH_ADVERBS_COLOR_BUTTON = 1028;
    static constexpr int ID_DOLCH_ADJECTIVES_COLOR_BUTTON = 1029;
    static constexpr int ID_DOLCH_NOUN_COLOR_BUTTON = 1030;
    static constexpr int ID_EXPORT_SETTINGS_BUTTON = 1031;
    static constexpr int ID_LOAD_SETTINGS_BUTTON = 1032;
    static constexpr int ID_RESET_SETTINGS_BUTTON = 1033;
    static constexpr int ID_TEXT_EXCLUDE_METHOD = 1036;
    static constexpr int ID_EXCLUDE_INCOMPLETE_SENTENCES_RADIO_BUTTON = 1039;
    static constexpr int ID_SENTENCE_LONGER_THAN_BUTTON = 1040;
    static constexpr int ID_SENTENCE_OUTLIER_LENGTH_BUTTON = 1041;
    static constexpr int ID_IGNORE_BLANK_LINES_BUTTON = 1042;
    static constexpr int ID_IGNORE_INDENTING_BUTTON = 1043;
    static constexpr int ID_WARNING_MESSAGES_BUTTON = 1044;
    static constexpr int ID_ADD_FILE_BUTTON = 1045;
    static constexpr int ID_DELETE_FILE_BUTTON = 1046;
    static constexpr int ID_NUMBER_SYLLABIZE_METHOD = 1048;
    static constexpr int ID_DOLCH_VERBS_COLOR_BUTTON = 1050;
    static constexpr int ID_AGGRESSIVE_LIST_DEDUCTION_CHECKBOX = 1051;
    static constexpr int ID_EXCLUDED_PHRASES_FILE_EDIT_BUTTON = 1052;
    static constexpr int ID_EXCLUDE_COPYRIGHT_CHECKBOX = 1054;
    static constexpr int ID_EXCLUDE_CITATIONS_CHECKBOX = 1055;
    static constexpr int ID_EXCLUDE_FILE_ADDRESS_CHECKBOX = 1056;
    static constexpr int ID_EXCLUDE_NUMERALS_CHECKBOX = 1057;
    static constexpr int ID_EXCLUDE_PROPER_NOUNS_CHECKBOX = 1058;
    static constexpr int ID_INCOMPLETE_SENTENCE_VALID_VALUE_BOX = 1059;
    static constexpr int ID_APPLY_GRAPH_BACKGROUND_COLOR_FADE_CHECK_BOX = 1060;
    static constexpr int ID_GRAPH_BACKGROUND_OPACITY_SLIDER_LABEL = 1061;
    static constexpr int ID_GRAPH_BACKGROUND_OPACITY_SLIDER_PLUS_LABEL = 1062;
    static constexpr int ID_PLOT_COLOR_LABEL = 1063;
    static constexpr int ID_WATERMARK_LABEL = 1065;
    static constexpr int ID_WATERMARK_TEXT_BOX = 1066;
    static constexpr int ID_GRAPH_LOGO_LABEL = 1067;
    static constexpr int ID_BAR_CHART_EFFECTS_OPTIONS = 1068;
    static constexpr int ID_BAR_CHART_HORIZONTAL_OPTION = 1069;
    static constexpr int ID_BAR_CHART_VERTICAL_OPTION = 1070;
    static constexpr int ID_DOCUMENT_FONT_LABEL = 1071;
    static constexpr int ID_GRAPH_OPTIONS_PROPERTYGRID = 1073;
    static constexpr int ID_BARCHART_OPTIONS_PROPERTYGRID = 1074;
    static constexpr int ID_INCLUDE_FIRST_OCCURRENCE_EXCLUDE_CHECKBOX = 1075;
    static constexpr int ID_INCOMPLETE_SENTENCE_VALID_LABEL_START = 1076;
    static constexpr int ID_INCOMPLETE_SENTENCE_VALID_LABEL_END = 1077;
    static constexpr int ID_EXCLUSION_TAG_BLOCK_LABEL = 1078;
    static constexpr int ID_EXCLUSION_TAG_BLOCK_SELCTION = 1079;
    static constexpr int ID_ADDITIONAL_FILE_BROWSE_BUTTON = 1080;
    static constexpr int ID_ADD_FILES_BUTTON = 1081;
    static constexpr int ID_THEME_COMBO = 1082;
    static constexpr int ID_ADDITIONAL_FILE_FIELD = 1083;
