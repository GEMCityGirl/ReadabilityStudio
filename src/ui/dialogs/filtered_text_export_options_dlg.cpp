...
void FilteredTextExportOptionsDlg::CreateControls()
    ...
    wxStaticBoxSizer* itemBoxSizer =
        new wxStaticBoxSizer(new wxStaticBox(this, wxID_ANY, _(L"Along with text exclusion, also:")), wxVERTICAL);
    ...
    mainSizer->Add(new wxStaticLine(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL), 1,
