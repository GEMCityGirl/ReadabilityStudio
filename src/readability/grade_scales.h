...
namespace readability
    ...
    enum class grade_scale
        ...
        k12_plus_alberta, /**<https://www.education.alberta.ca/media/832568/guidetoed.pdf
                          Elementary(Kindergarten-Grade 6)
                          Junior High (Grade 7-9)
                          Senior High (Grade 10-12)*/
        k12_plus_british_columbia, /**<https://www.bced.gov.bc.ca/reporting/glossary.php#G, Yukon has the same curriculum as BC (https://www.education.gov.yk.ca/psb/curriculum.html)
                                   Elementary (Kindergarten-Grade 7)
                                   Junior Secondary (Grade 8-10)
                                   Senior Secondary (Grade 11-12)*/
        k12_plus_manitoba, /**<https://www.edu.gov.mb.ca/ks4/schools/gts.html
                           Early (Kindergarten-Grade 4)
                           Middle (Grade 5-8)
                           Senior (Grade 9-12)*/
        k12_plus_newbrunswick, /**<https://www.gnb.ca/0000/anglophone-e.asp
                               Elementary (Kindergarten-Grade 5)
                               Middle School (Grade 6-8)
                               High School (Grade 9-12)*/
        k12_plus_newfoundland_and_labrador, /**<https://www.ed.gov.nl.ca/edu/sp/pcdbgl.htm
                                            Kindergarten
                                            Primary (Grade 1-3)
                                            Elementary (Grade 4-6)
                                            Intermediate (Grade 7-9)
                                            Senior High (Level I-III)*/
        k12_plus_northwest_territories, /**<https://www.ece.gov.nt.ca/Divisions/kindergarten_g12/curriculum/Elementary_Junior_Secondary_School_Handbook/Elementary_Junior_Secondary_School_Handbook.htm
                                        Primary (Kindergarten-Grade 3)
                                        Intermediate (Grade 4-6)
                                        Junior Secondary (Grade 7-9)
                                        Senior Secondary (Grade 10-12)*/        
        k12_plus_nova_scotia, /**<https://www.ednet.ns.ca/pdfdocs/psp/psp_03_04_full.pdf
                              Elementary (Primary-Grade 6)
                              Junior High (Grade 7-9)
                              Senior High (Grade 10-12)*/
        k12_plus_ontario, /**<https://www.edu.gov.on.ca/eng/educationFacts.html
        ...
        k12_plus_prince_edward_island, /**<https://www.edu.pe.ca/curriculum/default.asp
                                       Kindergarten
                                       Elementary (Grade 1-6)
                                       Intermediate School (Grade 7-9)
                                       Senior High (Grade 10-12)*/
        k12_plus_saskatchewan, /**<https://www.sasked.gov.sk.ca/branches/curr/index.shtml
                               Kindergarten
                               Elementary Level (Grade 1-5)
                               Middle Level (Grade 6-9)
                               Secondary Level (Grade 10-12)*/
        k12_plus_nunavut, /**https://www.ntanu.ca/assets/docs/Handout-Nunavut%20Approved%20Teaching%20Resources%20Version%20(5).pdf
                         Kindergarten, Grades 1-12. Unfortunately, this is as detailed information as I could find.*/
        quebec, /**https://www.ibe.unesco.org/en/access-by-country/europe-and-north-america/canada/curricular-resources.html
        ...
        key_stages_england_wales /**https://curriculum.qca.org.uk/index.aspx
    ...
    [[nodiscard]] constexpr inline double truncate_k12_plus_grade(const double value) noexcept
    ...
    inline void split_k12_plus_grade_score(double USGradeScore, size_t& grade, size_t& month) noexcept
        {
        ...
        fractpart = std::modf(USGradeScore, &intpart);
