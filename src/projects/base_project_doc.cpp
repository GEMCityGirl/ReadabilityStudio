...
void BaseProjectDoc::UpdateExplanationListOptions(ExplanationListCtrl* eList)
    ...
    eList->SetForegroundColour(ColorContrast::BlackOrWhiteContrast(wxGetApp().GetAppOptions().GetControlBackgroundColor()));
    eList->GetResultsListCtrl()->SetBackgroundColour(wxGetApp().GetAppOptions().GetControlBackgroundColor());
    eList->GetResultsListCtrl()->SetForegroundColour(ColorContrast::BlackOrWhiteContrast(wxGetApp().GetAppOptions().GetControlBackgroundColor()));
#endif
...
void BaseProjectDoc::UpdateListOptions(ListCtrlEx* list)
    ...
    list->SetForegroundColour(ColorContrast::BlackOrWhiteContrast(wxGetApp().GetAppOptions().GetControlBackgroundColor()));
...
//-------------------------------------------------------
CustomReadabilityTest::string_type BaseProjectDoc::UpdateCustumReadabilityTest(const CustomReadabilityTest::string_type& testFormula)
    {
    auto formula = testFormula;
    string_util::replace_all_whole_word<decltype(formula)>(formula, L"WORDCOUNT()", L"WordCount(Default)");
    string_util::replace_all_whole_word<decltype(formula)>(formula, L"SENTENCECOUNT()", L"SentenceCount(Default)");
    string_util::replace_all_whole_word<decltype(formula)>(formula, L"CHARACTERCOUNT()", L"CharacterCount(Default)");
    string_util::replace_all_whole_word<decltype(formula)>(formula, L"SYLLABLECOUNT()", L"SyllableCount(Default)");
    string_util::replace_all_whole_word<decltype(formula)>(formula, L"THREESYLLABLEPLUSWORDCOUNT()", L"ThreeSyllablePlusWordCount(Default)");
    string_util::replace_all_whole_word<decltype(formula)>(formula, L"UNIQUETHREESYLLABLEPLUSWORDCOUNT()", L"UniqueThreeSyllablePlusWordCount(Default)");
...
bool BaseProjectDoc::AddGlobalCustomReadabilityTest(CustomReadabilityTest& customTest)
    ...
    if (std::find(m_custom_word_tests.begin(), m_custom_word_tests.end(), customTest.get_name()) != m_custom_word_tests.end())
        {
...
void BaseProjectDoc::LoadSettingsFile(const wxChar* settingsFileText)
    ...
    if (docParsingSection && docParsingSectionEnd &&
        ...
        SetTextSource(static_cast<TextSource>(XmlFormat::GetLong(docParsingSection, docParsingSectionEnd, wxGetApp().GetAppOptions().XML_TEXT_SOURCE,
        ...
        XmlFormat::GetStringsWithExtraInfo(docParsingSection, docParsingSectionEnd,
                                           ...
                                           GetSourceFilesInfo());
        //reviewer and status
        SetReviewer(XmlFormat::GetString(docParsingSection, docParsingSectionEnd, wxGetApp().GetAppOptions().XML_REVIEWER));
        SetStatus(XmlFormat::GetString(docParsingSection, docParsingSectionEnd, wxGetApp().GetAppOptions().XML_STATUS));
        //appended doc
        ...
        SetDocumentStorageMethod(static_cast<TextStorage>(XmlFormat::GetLong(docParsingSection, docParsingSectionEnd, wxGetApp().GetAppOptions().XML_DOCUMENT_STORAGE_METHOD,
        ...
        //Min doc size
        SetMinDocWordCountForBatch(static_cast<size_t>(XmlFormat::GetLong(docParsingSection, docParsingSectionEnd, wxGetApp().GetAppOptions().XML_MIN_DOC_SIZE_FOR_BATCH,
        ...
        long truncMode = XmlFormat::GetLong(docParsingSection, docParsingSectionEnd, wxGetApp().GetAppOptions().XML_FILE_PATH_TRUNC_MODE,
        ...
        m_exportFolder = XmlFormat::GetString(docParsingSection, docParsingSectionEnd, wxGetApp().GetAppOptions().XML_EXPORT_FOLDER_PATH);
        m_exportFile = XmlFormat::GetString(docParsingSection, docParsingSectionEnd, wxGetApp().GetAppOptions().XML_EXPORT_FILE_PATH);
        }
    ...
    if (sentencesBreakdownSection && sentencesBreakdownSectionEnd)
        {
        const wxString wordsBreakdownInfo = XmlFormat::GetString(sentencesBreakdownSection, sentencesBreakdownSectionEnd, wxGetApp().GetAppOptions().XML_SENTENCES_BREAKDOWN_INFO);
    ...
    if (wordsBreakdownSection && wordsBreakdownSectionSectionEnd)
        {
        const wxString wordsBreakdownInfo = XmlFormat::GetString(wordsBreakdownSection, wordsBreakdownSectionSectionEnd, wxGetApp().GetAppOptions().XML_WORDS_BREAKDOWN_INFO);
        if (wordsBreakdownInfo.length())
    ...
    if (grammarSection && grammarSectionEnd &&
        ...
        {
        SpellCheckIgnoreProperNouns(XmlFormat::GetBoolean(grammarSection, grammarSectionEnd,
            wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_PROPER_NOUNS, wxGetApp().GetAppOptions().SpellCheckIsIgnoringProperNouns()) );
        SpellCheckIgnoreUppercased(XmlFormat::GetBoolean(grammarSection, grammarSectionEnd,
            wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_UPPERCASED, wxGetApp().GetAppOptions().SpellCheckIsIgnoringUppercased()) );
        SpellCheckIgnoreNumerals(XmlFormat::GetBoolean(grammarSection, grammarSectionEnd,
            wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_NUMERALS, wxGetApp().GetAppOptions().SpellCheckIsIgnoringNumerals()) );
        SpellCheckIgnoreFileAddresses(XmlFormat::GetBoolean(grammarSection, grammarSectionEnd,
            wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_FILE_ADDRESSES, wxGetApp().GetAppOptions().SpellCheckIsIgnoringFileAddresses()) );
        SpellCheckIgnoreProgrammerCode(XmlFormat::GetBoolean(grammarSection, grammarSectionEnd,
            wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_PROGRAMMER_CODE, wxGetApp().GetAppOptions().SpellCheckIsIgnoringProgrammerCode()) );
        SpellCheckAllowColloquialisms(XmlFormat::GetBoolean(grammarSection, grammarSectionEnd,
            wxGetApp().GetAppOptions().XML_SPELLCHECK_ALLOW_COLLOQUIALISMS, wxGetApp().GetAppOptions().SpellCheckIsAllowingColloquialisms()) );
        SpellCheckIgnoreSocialMediaTags(XmlFormat::GetBoolean(grammarSection, grammarSectionEnd,
            wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_SOCIAL_MEDIA_TAGS, wxGetApp().GetAppOptions().SpellCheckIsIgnoringSocialMediaTags()));
        const wxString grammarInfo = XmlFormat::GetString(grammarSection, grammarSectionEnd, wxGetApp().GetAppOptions().XML_GRAMMAR_INFO);
    ...
    if (parsingSection && parsingSectionEnd &&
        ...
        SetLongSentenceMethod(static_cast<LongSentence>(XmlFormat::GetLong(parsingSection, parsingSectionEnd, wxGetApp().GetAppOptions().XML_LONG_SENTENCE_METHOD,
        ...
        SetDifficultSentenceLength(static_cast<int>(XmlFormat::GetLong(parsingSection, parsingSectionEnd, wxGetApp().GetAppOptions().XML_LONG_SENTENCE_LENGTH,
                                         static_cast<long>(GetDifficultSentenceLength()))));
        //get the method for numeral syllabizing
        SetNumeralSyllabicationMethod(static_cast<NumeralSyllabize>(XmlFormat::GetLong(parsingSection, parsingSectionEnd, wxGetApp().GetAppOptions().XML_NUMERAL_SYLLABICATION_METHOD,
        ...
        SetIgnoreBlankLinesForParagraphsParser(XmlFormat::GetBoolean(parsingSection, parsingSectionEnd,
            wxGetApp().GetAppOptions().XML_IGNORE_BLANK_LINES_FOR_PARAGRAPH_PARSING, wxGetApp().GetAppOptions().GetIgnoreBlankLinesForParagraphsParser()));
        ...
        SetIgnoreIndentingForParagraphsParser(XmlFormat::GetBoolean(parsingSection, parsingSectionEnd,
            wxGetApp().GetAppOptions().XML_IGNORE_INDENTING_FOR_PARAGRAPH_PARSING, wxGetApp().GetAppOptions().GetIgnoreIndentingForParagraphsParser()));
        ...
        SetSentenceStartMustBeUppercased(XmlFormat::GetBoolean(parsingSection, parsingSectionEnd,
            wxGetApp().GetAppOptions().XML_SENTENCES_MUST_START_CAPITALIZED, wxGetApp().GetAppOptions().GetSentenceStartMustBeUppercased()));
        ...
        IncludeExcludedPhraseFirstOccurrence(XmlFormat::GetBoolean(parsingSection, parsingSectionEnd,
            wxGetApp().GetAppOptions().XML_EXCLUDED_PHRASES_INCLUDE_FIRST_OCCURRENCE, wxGetApp().GetAppOptions().IsIncludingExcludedPhraseFirstOccurrence()));
        //whether to ignore proper nouns
        IgnoreProperNouns(XmlFormat::GetBoolean(parsingSection, parsingSectionEnd,
            wxGetApp().GetAppOptions().XML_IGNORE_PROPER_NOUNS, wxGetApp().GetAppOptions().IsIgnoringProperNouns()));
        //whether to ignore numerals
        IgnoreNumerals(XmlFormat::GetBoolean(parsingSection, parsingSectionEnd,
            wxGetApp().GetAppOptions().XML_IGNORE_NUMERALS, wxGetApp().GetAppOptions().IsIgnoringNumerals()));
        //whether to ignore file addresses
        IgnoreFileAddresses(XmlFormat::GetBoolean(parsingSection, parsingSectionEnd,
            wxGetApp().GetAppOptions().XML_IGNORE_FILE_ADDRESSES, wxGetApp().GetAppOptions().IsIgnoringFileAddresses()));
        //whether to ignore trailing citations
        IgnoreTrailingCitations(XmlFormat::GetBoolean(parsingSection, parsingSectionEnd,
            wxGetApp().GetAppOptions().XML_IGNORE_CITATIONS, wxGetApp().GetAppOptions().IsIgnoringTrailingCitations()));
        //whether to use aggressive list deduction
        AggressiveExclusion(XmlFormat::GetBoolean(parsingSection, parsingSectionEnd,
            wxGetApp().GetAppOptions().XML_AGGRESSIVE_EXCLUSION, wxGetApp().GetAppOptions().IsExcludingAggressively()));
        ...
        IgnoreTrailingCopyrightNoticeParagraphs(XmlFormat::GetBoolean(parsingSection, parsingSectionEnd,
            wxGetApp().GetAppOptions().XML_IGNORE_COPYRIGHT_NOTICES, wxGetApp().GetAppOptions().IsIgnoringTrailingCopyrightNoticeParagraphs()));
        //get the method for parsing paragraphs
        SetParagraphsParsingMethod(static_cast<ParagraphParse>(XmlFormat::GetLong(parsingSection, parsingSectionEnd, wxGetApp().GetAppOptions().XML_PARAGRAPH_PARSING_METHOD,
        ...
        if (GetParagraphsParsingMethod() != ParagraphParse::OnlySentenceTerminatedNewLinesAreParagraphs &&
            ...
            { SetParagraphsParsingMethod(static_cast<ParagraphParse>(wxGetApp().GetAppOptions().GetParagraphsParsingMethod())); }
        //Number of words that will make an incomplete sentence actually complete
        SetIncludeIncompleteSentencesIfLongerThanValue(XmlFormat::GetLong(parsingSection, parsingSectionEnd, wxGetApp().GetAppOptions().XML_INCLUDE_INCOMPLETE_SENTENCES_LONGER_THAN,
    ...
    if (customTestSection && customTestSectionEnd &&
        ...
        while (customFamiliarTestSection && customFamiliarTestSectionEnd)
            ...
            wxString filePath = XmlFormat::GetString(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_FAMILIAR_WORD_FILE_PATH);
            if (!wxFile::Exists(filePath) )
                {
                //if word list file not found, then try to search for it in the subdirectories from where the project is
                wxString fileBySameNameInProjectDirectory;
                if (FindMissingFile(filePath, fileBySameNameInProjectDirectory))
                    { filePath = fileBySameNameInProjectDirectory; }
                }
            long testType = XmlFormat::GetLong(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_TEST_TYPE, 0);
            if (testType < 0 || testType >= static_cast<int>(readability::readability_test_type::TEST_TYPE_COUNT))
                { testType = 0; }
            long stemmingType = XmlFormat::GetLong(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_STEMMING_TYPE, 0);
            if (stemmingType < 0 || stemmingType >= static_cast<int>(stemming::stemming_type::STEMMING_TYPE_COUNT))
                { stemmingType = 0; }
            long formulaType = XmlFormat::GetLong(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_TEST_FORMULA_TYPE, 0);
            if (formulaType != 0 && formulaType != 1)
                { formulaType = 0; }
            wxString formula = XmlFormat::GetString(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_TEST_FORMULA);
            ...
            // goals
            const double minGoal = XmlFormat::GetDouble(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_GOAL_MIN_VAL_GOAL, std::numeric_limits<double>::quiet_NaN());
            const double maxGoal = XmlFormat::GetDouble(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_GOAL_MAX_VAL_GOAL, std::numeric_limits<double>::quiet_NaN());
            // include options
            const int includeProperNouns = XmlFormat::GetLong(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INCLUDE_PROPER_NOUNS, 1);
            const bool includeNumeric = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INCLUDE_NUMERIC, true);
            const bool includeCustomWordList = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INCLUDE_CUSTOM_WORD_LIST, true);
            const bool includeDCTest = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INCLUDE_DC_LIST, false);
            const bool includeSpacheTest = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INCLUDE_SPACHE_LIST, false);
            const bool includeHJList = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INCLUDE_HARRIS_JACOBSON_LIST, false);
            const bool includeStockerList = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INCLUDE_STOCKER_LIST, false);
            const bool familiar_words_must_be_on_each_included_list = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_FAMILIAR_WORDS_ALL_LISTS, false);
            //industry
            const bool industryChildrensPublishingSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INDUSTRY_CHILDRENS_PUBLISHING, false);
            const bool industryAdultPublishingSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INDUSTRY_ADULTPUBLISHING, false);
            const bool industrySecondaryLanguageSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INDUSTRY_SECONDARY_LANGUAGE, false);
            const bool industryChildrensHealthCareSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INDUSTRY_CHILDRENS_HEALTHCARE, false);
            const bool industryAdultHealthCareSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INDUSTRY_ADULT_HEALTHCARE, false);
            const bool industryMilitaryGovernmentSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INDUSTRY_MILITARY_GOVERNMENT, false);
            const bool industryBroadcastingSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_INDUSTRY_BROADCASTING, false);
            //document
            const bool documentGeneralSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_DOCUMENT_GENERAL, false);
            const bool documentTechSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_DOCUMENT_TECHNICAL, false);
            const bool documentFormSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_DOCUMENT_FORM, false);
            const bool documentYoungAdultSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_DOCUMENT_YOUNGADULT, false);
            const bool documentChildrenSelected = XmlFormat::GetBoolean(customFamiliarTestSection, customFamiliarTestSectionEnd, wxGetApp().GetAppOptions().XML_DOCUMENT_CHILDREN_LIT, false);
            ...
            if (std::find(m_custom_word_tests.begin(), m_custom_word_tests.end(), testName) != m_custom_word_tests.end())
                {
                //test with the same name was found, but dirty document if it can't find a test with the same name and settings
                if (std::find(m_custom_word_tests.begin(), m_custom_word_tests.end(), cTest) == m_custom_word_tests.end())
                    { SetModifiedFlag(); }
                }
    ...
    if (graphsSection && graphsSectionEnd &&
        ...
        SetBackGroundImagePath(XmlFormat::GetString(graphsSection, graphsSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_BACKGROUND_IMAGE_PATH));

        SetBackGroundColor(XmlFormat::GetColor(graphsSection, graphsSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_BACKGROUND_COLOR, wxGetApp().GetAppOptions().GetBackGroundColor()));

        SetPlotBackGroundColor(XmlFormat::GetColor(graphsSection, graphsSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_PLOT_BACKGROUND_COLOR, wxGetApp().GetAppOptions().GetPlotBackGroundColor()));

        SetGraphBackGroundOpacity(XmlFormat::GetLong(graphsSection, graphsSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_BACKGROUND_OPACITY, wxGetApp().GetAppOptions().GetGraphBackGroundOpacity()));
        SetGraphPlotBackGroundOpacity(XmlFormat::GetLong(graphsSection, graphsSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_PLOT_BACKGROUND_OPACITY, wxGetApp().GetAppOptions().GetGraphPlotBackGroundOpacity()));

        SetGraphBackGroundLinearGradient(XmlFormat::GetBoolean(graphsSection, graphsSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_BACKGROUND_LINEAR_GRADIENT, wxGetApp().GetAppOptions().GetGraphBackGroundLinearGradient()));

        SetStippleImagePath(XmlFormat::GetString(graphsSection, graphsSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_STIPPLE_PATH));

        DisplayDropShadows(XmlFormat::GetBoolean(graphsSection, graphsSectionEnd, wxGetApp().GetAppOptions().XML_DISPLAY_DROP_SHADOW, wxGetApp().GetAppOptions().IsDisplayingDropShadows()));

        SetWatermark(XmlFormat::GetString(graphsSection, graphsSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_WATERMARK));
        SetWatermarkLogoPath(XmlFormat::GetString(graphsSection, graphsSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_WATERMARK_LOGO_IMAGE_PATH));
        ...
        if (lixGuageSection && lixGuageSectionEnd &&
            ...
            {
            UseEnglishLabelsForGermanLix(XmlFormat::GetBoolean(lixGuageSection, lixGuageSectionEnd, wxGetApp().GetAppOptions().XML_USE_ENGLISH_LABELS, wxGetApp().GetAppOptions().IsUsingEnglishLabelsForGermanLix()));
            }
        ...
        if (fleschChartSection && fleschChartSectionEnd &&
            ...
            {
            ConnectFleschPoints(XmlFormat::GetBoolean(fleschChartSection, fleschChartSectionEnd, wxGetApp().GetAppOptions().XML_INCLUDE_CONNECTION_LINE, wxGetApp().GetAppOptions().IsConnectingFleschPoints()));
            }
        ...
        if (boxPlotSection && boxPlotSectionEnd &&
            ...
            {
            SetGraphBoxColor(XmlFormat::GetColor(boxPlotSection, boxPlotSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_COLOR, wxGetApp().GetAppOptions().GetGraphBoxColor()));
            long boxEffect = XmlFormat::GetLong(boxPlotSection, boxPlotSectionEnd, wxGetApp().GetAppOptions().XML_BOX_EFFECT, static_cast<long>(wxGetApp().GetAppOptions().GetGraphBoxEffect()));
            ...
            SetGraphBoxOpacity(XmlFormat::GetLong(boxPlotSection, boxPlotSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_OPACITY, wxGetApp().GetAppOptions().GetGraphBoxOpacity()));
            ShowAllBoxPlotPoints(XmlFormat::GetBoolean(boxPlotSection, boxPlotSectionEnd, wxGetApp().GetAppOptions().XML_BOX_PLOT_SHOW_ALL_POINTS, wxGetApp().GetAppOptions().IsShowingAllBoxPlotPoints()));
            DisplayBoxPlotLabels(XmlFormat::GetBoolean(boxPlotSection, boxPlotSectionEnd, wxGetApp().GetAppOptions().XML_BOX_DISPLAY_LABELS, wxGetApp().GetAppOptions().IsDisplayingBoxPlotLabels()));
            ConnectBoxPlotMiddlePoints(XmlFormat::GetBoolean(boxPlotSection, boxPlotSectionEnd, wxGetApp().GetAppOptions().XML_BOX_CONNECT_MIDDLE_POINTS, wxGetApp().GetAppOptions().IsConnectingBoxPlotMiddlePoints()));
            }
        ...
        if (histoSection && histoSectionEnd &&
            ...
            {
            long barEffect = XmlFormat::GetLong(histoSection, histoSectionEnd, wxGetApp().GetAppOptions().XML_BAR_EFFECT, static_cast<long>(wxGetApp().GetAppOptions().GetHistogramBarEffect()));
            ...
            SetHistogramBarColor(XmlFormat::GetColor(histoSection, histoSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_COLOR, wxGetApp().GetAppOptions().GetHistogramBarColor()));
            SetHistogramBarOpacity(XmlFormat::GetLong(histoSection, histoSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_OPACITY, wxGetApp().GetAppOptions().GetHistogramBarOpacity()));
            //how values are binned
            long catMethod = XmlFormat::GetLong(histoSection, histoSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_BINNING_METHOD, static_cast<long>(wxGetApp().GetAppOptions().GetHistorgramBinningMethod()));
            if (catMethod < 0 || catMethod >= static_cast<decltype(catMethod)>(Histogram::BinningMethod::BINNING_METHOD_COUNT))
            ...
            long roundMethod = XmlFormat::GetLong(histoSection, histoSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_ROUNDING_METHOD, static_cast<long>(wxGetApp().GetAppOptions().GetHistogramRoundingMethod()));
            ...
            long intervalDisplayMethod = XmlFormat::GetLong(histoSection, histoSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_INTERVAL_DISPLAY, static_cast<long>(wxGetApp().GetAppOptions().GetHistogramIntervalDisplay()));
            if (intervalDisplayMethod < 0 || intervalDisplayMethod >= static_cast<decltype(intervalDisplayMethod)>(Histogram::IntervalDisplay::INTERVAL_METHOD_COUNT) )
            ...
            long catDisplayMethod = XmlFormat::GetLong(histoSection, histoSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_BINNING_LABEL_DISPLAY, static_cast<long>(wxGetApp().GetAppOptions().GetHistrogramBinLabelDisplay()));
            if (catDisplayMethod < 0 || catDisplayMethod >= static_cast<decltype(catDisplayMethod)>(BinLabelDisplay::BIN_LABEL_DISPLAY_COUNT))
        ...
        if (barSection && barSectionEnd &&
            ...
            {
            SetBarChartBarColor(XmlFormat::GetColor(barSection, barSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_COLOR, wxGetApp().GetAppOptions().GetBarChartBarColor()));
            long barEffect = XmlFormat::GetLong(barSection, barSectionEnd, wxGetApp().GetAppOptions().XML_BAR_EFFECT, static_cast<long>(wxGetApp().GetAppOptions().GetGraphBarEffect()));
            ...
            long orientation = XmlFormat::GetLong(barSection, barSectionEnd,
                wxGetApp().GetAppOptions().XML_BAR_ORIENTATION, static_cast<decltype(orientation)>(wxGetApp().GetAppOptions().GetBarChartOrientation()));
            ...
            DisplayBarLabels(XmlFormat::GetBoolean(barSection, barSectionEnd, wxGetApp().GetAppOptions().XML_BAR_DISPLAY_LABELS, wxGetApp().GetAppOptions().IsDisplayingBarLabels()));
            SetBarChartOrientation(static_cast<Wisteria::Orientation>(orientation));
            SetGraphBarOpacity(XmlFormat::GetLong(barSection, barSectionEnd, wxGetApp().GetAppOptions().XML_GRAPH_OPACITY, wxGetApp().GetAppOptions().GetGraphBarOpacity()));
            }
        ...
        if (axisSection && axisSectionEnd &&
            ...
            if (xAxisSection && xAxisSectionEnd &&
                ...
                {
                SetXAxisFontColor(XmlFormat::GetColor(xAxisSection, xAxisSectionEnd, wxGetApp().GetAppOptions().XML_FONT_COLOR, wxGetApp().GetAppOptions().GetXAxisFontColor()));
            ...
            if (yAxisSection && yAxisSectionEnd &&
                ...
                {
                SetYAxisFontColor(XmlFormat::GetColor(yAxisSection, yAxisSectionEnd, wxGetApp().GetAppOptions().XML_FONT_COLOR, wxGetApp().GetAppOptions().GetYAxisFontColor()));
                SetYAxisFont(XmlFormat::GetFont(yAxisSection, yAxisSectionEnd, wxGetApp().GetAppOptions().XML_FONT, wxGetApp().GetAppOptions().GetYAxisFont()));
                }
            }
        ...
        if (titleSection && titleSectionEnd &&
            ...
            if (topTitleSection && topTitleSectionEnd &&
                ...
                {
                SetTopTitleGraphFontColor(XmlFormat::GetColor(topTitleSection, topTitleSectionEnd, wxGetApp().GetAppOptions().XML_FONT_COLOR, wxGetApp().GetAppOptions().GetTopTitleGraphFontColor()));
                SetTopTitleGraphFont(XmlFormat::GetFont(topTitleSection, topTitleSectionEnd, wxGetApp().GetAppOptions().XML_FONT, wxGetApp().GetAppOptions().GetTopTitleGraphFont()));
                }
            ...
            if (bottomTitleSection && bottomTitleSectionEnd &&
                ...
                {
                SetBottomTitleGraphFontColor(XmlFormat::GetColor(bottomTitleSection, bottomTitleSectionEnd, wxGetApp().GetAppOptions().XML_FONT_COLOR, wxGetApp().GetAppOptions().GetBottomTitleGraphFontColor()));
                SetBottomTitleGraphFont(XmlFormat::GetFont(bottomTitleSection, bottomTitleSectionEnd, wxGetApp().GetAppOptions().XML_FONT, wxGetApp().GetAppOptions().GetBottomTitleGraphFont()));
                }
            ...
            if (leftTitleSection && leftTitleSectionEnd &&
                ...
                {
                SetLeftTitleGraphFontColor(XmlFormat::GetColor(leftTitleSection, leftTitleSectionEnd, wxGetApp().GetAppOptions().XML_FONT_COLOR, wxGetApp().GetAppOptions().GetLeftTitleGraphFontColor()));
                SetLeftTitleGraphFont(XmlFormat::GetFont(leftTitleSection, leftTitleSectionEnd, wxGetApp().GetAppOptions().XML_FONT, wxGetApp().GetAppOptions().GetLeftTitleGraphFont()));
                }
            ...
            if (rightTitleSection && rightTitleSectionEnd &&
                ...
                {
                SetRightTitleGraphFontColor(XmlFormat::GetColor(rightTitleSection, rightTitleSectionEnd, wxGetApp().GetAppOptions().XML_FONT_COLOR, wxGetApp().GetAppOptions().GetRightTitleGraphFontColor()));
                SetRightTitleGraphFont(XmlFormat::GetFont(rightTitleSection, rightTitleSectionEnd, wxGetApp().GetAppOptions().XML_FONT, wxGetApp().GetAppOptions().GetRightTitleGraphFont()));
                }
            }
        }
    ...
    if (statGoalsSection && statGoalsSectionEnd)
        ...
        for (const auto& statGoal : GetStatGoalLabels())
            {
            auto minGoal = XmlFormat::GetAttributeDoubleValue(statGoalsSection, statGoalsSectionEnd, statGoal.first.first.c_str(),
                wxGetApp().GetAppOptions().XML_GOAL_MIN_VAL_GOAL.wc_str(), std::numeric_limits<double>::quiet_NaN());
            auto maxGoal = XmlFormat::GetAttributeDoubleValue(statGoalsSection, statGoalsSectionEnd, statGoal.first.first.c_str(),
    ...
    if (statsSection && statsSectionEnd)
        {
        SetVarianceMethod(static_cast<VarianceMethod>(XmlFormat::GetLong(statsSection, statsSectionEnd, wxGetApp().GetAppOptions().XML_VARIANCE_METHOD,
                                    static_cast<long>(wxGetApp().GetAppOptions().GetVarianceMethod()))));
        const wxString statsInfo = XmlFormat::GetString(statsSection, statsSectionEnd, wxGetApp().GetAppOptions().XML_STATISTICS_REPORT);
        if (statsInfo.length())
            { GetStatisticsReportInfo().Set(statsInfo); }
        const wxString statsResultInfo = XmlFormat::GetString(statsSection, statsSectionEnd, wxGetApp().GetAppOptions().XML_STATISTICS_RESULTS);
    ...
    if (readabilityTestSection && readabilityTestSectionEnd)
        ...
        IncludeScoreSummaryReport((XmlFormat::GetBoolean(readabilityTestSection, readabilityTestSectionEnd,
            wxGetApp().GetAppOptions().XML_INCLUDE_SCORES_SUMMARY_REPORT, wxGetApp().GetAppOptions().IsIncludingScoreSummaryReport())) );
        //grade scale/reading age display
        GetReadabilityMessageCatalog().SetReadingAgeDisplay(static_cast<ReadabilityMessages::ReadingAgeDisplay>(XmlFormat::GetLong(readabilityTestSection, readabilityTestSectionEnd,
            wxGetApp().GetAppOptions().XML_READING_AGE_FORMAT, static_cast<long>(wxGetApp().GetAppOptions().GetReadabilityMessageCatalog().GetReadingAgeDisplay()))) );
        GetReadabilityMessageCatalog().SetGradeScale(static_cast<readability::grade_scale>(XmlFormat::GetLong(readabilityTestSection, readabilityTestSectionEnd,
            wxGetApp().GetAppOptions().XML_READABILITY_TEST_GRADE_SCALE_DISPLAY, static_cast<long>(wxGetApp().GetAppOptions().GetReadabilityMessageCatalog().GetGradeScale()))) );
        GetReadabilityMessageCatalog().SetLongGradeScaleFormat(XmlFormat::GetBoolean(readabilityTestSection, readabilityTestSectionEnd,
            wxGetApp().GetAppOptions().XML_READABILITY_TEST_GRADE_SCALE_LONG_FORMAT, wxGetApp().GetAppOptions().GetReadabilityMessageCatalog().IsUsingLongGradeScaleFormat()) );

        // which standard tests are included
        for (auto& rTest : GetReadabilityTests().get_tests())
            {
            rTest.include(XmlFormat::GetBoolean(readabilityTestSection, readabilityTestSectionEnd, rTest.get_test().get_id().c_str(), false));
            auto minGoal = XmlFormat::GetAttributeDoubleValue(readabilityTestSection, readabilityTestSectionEnd, rTest.get_test().get_id().c_str(),
                            wxGetApp().GetAppOptions().XML_GOAL_MIN_VAL_GOAL.wc_str(), std::numeric_limits<double>::quiet_NaN());
            auto maxGoal = XmlFormat::GetAttributeDoubleValue(readabilityTestSection, readabilityTestSectionEnd, rTest.get_test().get_id().c_str(),
                            wxGetApp().GetAppOptions().XML_GOAL_MAX_VAL_GOAL.wc_str(), std::numeric_limits<double>::quiet_NaN());
            if (!std::isnan(minGoal) || !std::isnan(maxGoal))
                {
        ...
        if (fleschKincaidOptionsSection && fleschKincaidOptionsSectionEnd)
            {
            SetFleschKincaidNumeralSyllabizeMethod(static_cast<FleschKincaidNumeralSyllabize>(XmlFormat::GetLong(fleschKincaidOptionsSection, fleschKincaidOptionsSectionEnd,
        ...
        if (fleschOptionsSection && fleschOptionsSectionEnd)
            {
            SetFleschNumeralSyllabizeMethod(static_cast<FleschNumeralSyllabize>(XmlFormat::GetLong(fleschOptionsSection, fleschOptionsSectionEnd,
        ...
        if (hjOptionsSection && hjOptionsSectionEnd)
            {
            SetHarrisJacobsonTextExclusionMode(static_cast<SpecializedTestTextExclusion>(XmlFormat::GetLong(hjOptionsSection, hjOptionsSectionEnd,
        ...
        if (dcOptionsSection && dcOptionsSectionEnd)
            ...
            IncludeStockerCatholicSupplement(XmlFormat::GetBoolean(dcOptionsSection, dcOptionsSectionEnd,
                wxGetApp().GetAppOptions().XML_STOCKER_LIST, wxGetApp().GetAppOptions().IsIncludingStockerCatholicSupplement()));
            SetDaleChallTextExclusionMode(static_cast<SpecializedTestTextExclusion>(XmlFormat::GetLong(dcOptionsSection, dcOptionsSectionEnd,
                wxGetApp().GetAppOptions().XML_TEXT_EXCLUSION, static_cast<int>(wxGetApp().GetAppOptions().GetDaleChallTextExclusionMode()))) );
            SetDaleChallProperNounCountingMethod(static_cast<readability::proper_noun_counting_method>(XmlFormat::GetLong(dcOptionsSection, dcOptionsSectionEnd,
                wxGetApp().GetAppOptions().XML_PROPER_NOUN_COUNTING_METHOD, static_cast<int>(wxGetApp().GetAppOptions().GetDaleChallProperNounCountingMethod()))) );
            }
        }
    else
        {
    ...
    if (textViewsSection && textViewsSectionEnd &&
        ...
        {
        m_textHighlight = static_cast<TextHighlight>(XmlFormat::GetLong(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_HIGHLIGHT_METHOD,
                                        static_cast<long>(wxGetApp().GetAppOptions().GetTextHighlightMethod())));
        m_textViewHighlightColor = XmlFormat::GetColor(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_HIGHLIGHTCOLOR, wxGetApp().GetAppOptions().GetTextHighlightColor() );
        m_excludedTextHighlightColor = XmlFormat::GetColor(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_EXCLUDED_HIGHLIGHTCOLOR, wxGetApp().GetAppOptions().GetExcludedTextHighlightColor() );
        m_duplicateWordHighlightColor = XmlFormat::GetColor(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_DUP_WORD_HIGHLIGHTCOLOR, wxGetApp().GetAppOptions().GetDuplicateWordHighlightColor() );
        m_wordyPhraseHighlightColor = XmlFormat::GetColor(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_WORDY_PHRASE_HIGHLIGHTCOLOR, wxGetApp().GetAppOptions().GetWordyPhraseHighlightColor() );
        m_fontColor = XmlFormat::GetColor(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_DOCUMENT_DISPLAY_FONTCOLOR, wxGetApp().GetAppOptions().GetTextFontColor() );
        m_textViewFont = XmlFormat::GetFont(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_DOCUMENT_DISPLAY_FONT, wxGetApp().GetAppOptions().GetTextViewFont());
        //dolch highlighting
        m_dolchConjunctionsColor = XmlFormat::GetColorWithInclusionTag(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_DOLCH_CONJUNCTIONS_HIGHLIGHTCOLOR, m_highlightDolchConjunctions,
            wxGetApp().GetAppOptions().GetDolchConjunctionsColor(), wxGetApp().GetAppOptions().IsHighlightingDolchConjunctions() );
        m_dolchPrepositionsColor = XmlFormat::GetColorWithInclusionTag(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_DOLCH_PREPOSITIONS_HIGHLIGHTCOLOR, m_highlightDolchPrepositions,
            wxGetApp().GetAppOptions().GetDolchPrepositionsColor(), wxGetApp().GetAppOptions().IsHighlightingDolchPrepositions() );
        m_dolchPronounsColor = XmlFormat::GetColorWithInclusionTag(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_DOLCH_PRONOUNS_HIGHLIGHTCOLOR, m_highlightDolchPronouns,
            wxGetApp().GetAppOptions().GetDolchPronounsColor(), wxGetApp().GetAppOptions().IsHighlightingDolchPronouns() );
        m_dolchAdverbsColor = XmlFormat::GetColorWithInclusionTag(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_DOLCH_ADVERBS_HIGHLIGHTCOLOR, m_highlightDolchAdverbs,
            wxGetApp().GetAppOptions().GetDolchAdverbsColor(), wxGetApp().GetAppOptions().IsHighlightingDolchAdverbs() );
        m_dolchAdjectivesColor = XmlFormat::GetColorWithInclusionTag(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_DOLCH_ADJECTIVES_HIGHLIGHTCOLOR, m_highlightDolchAdjectives,
            wxGetApp().GetAppOptions().GetDolchAdjectivesColor(), wxGetApp().GetAppOptions().IsHighlightingDolchAdjectives() );
        m_dolchVerbsColor = XmlFormat::GetColorWithInclusionTag(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_DOLCH_VERBS_HIGHLIGHTCOLOR, m_highlightDolchVerbs,
            wxGetApp().GetAppOptions().GetDolchVerbsColor(), wxGetApp().GetAppOptions().IsHighlightingDolchVerbs() );
        m_dolchNounColor = XmlFormat::GetColorWithInclusionTag(textViewsSection, textViewsSectionEnd, wxGetApp().GetAppOptions().XML_DOLCH_NOUNS_HIGHLIGHTCOLOR, m_highlightDolchNouns,
            wxGetApp().GetAppOptions().GetDolchNounColor(), wxGetApp().GetAppOptions().IsHighlightingDolchNouns() );
        }
    else
        {
...
wxString BaseProjectDoc::FormatProjectSettings() const
    ...
    //storage/linking
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_DOCUMENT_STORAGE_METHOD, static_cast<int>(GetDocumentStorageMethod()), 2);
    fileText += sectionText;

    //Min doc size
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_MIN_DOC_SIZE_FOR_BATCH, GetMinDocWordCountForBatch(), 2);
    fileText += sectionText;

    //how file paths are shown in batch projects
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_FILE_PATH_TRUNC_MODE, static_cast<int>(GetFilePathTruncationMode()), 2);
    fileText += sectionText;
    ...
    //appended doc
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_APPENDED_DOC_PATH, GetAppendedDocumentFilePath(), 2);
    fileText += sectionText;

    //Project language
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_PROJECT_LANGUAGE, static_cast<int>(GetProjectLanguage()), 2);
    fileText += sectionText;
    ...
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_UPPERCASED, SpellCheckIsIgnoringUppercased(), 3);
    fileText += sectionText;

    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_NUMERALS, SpellCheckIsIgnoringNumerals(), 3);
    fileText += sectionText;

    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_FILE_ADDRESSES, SpellCheckIsIgnoringFileAddresses(), 3);
    fileText += sectionText;

    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_PROGRAMMER_CODE, SpellCheckIsIgnoringProgrammerCode(), 3);
    fileText += sectionText;

    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_SPELLCHECK_ALLOW_COLLOQUIALISMS, SpellCheckIsAllowingColloquialisms(), 3);
    fileText += sectionText;

    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_SPELLCHECK_IGNORE_SOCIAL_MEDIA_TAGS, SpellCheckIsIgnoringSocialMediaTags(), 3);
    fileText += sectionText;
    ...
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_IGNORE_BLANK_LINES_FOR_PARAGRAPH_PARSING, GetIgnoreBlankLinesForParagraphsParser(), 2);
    fileText += sectionText;
    //whether we should ignore indenting when parsing paragraphs
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_IGNORE_INDENTING_FOR_PARAGRAPH_PARSING, GetIgnoreIndentingForParagraphsParser(), 2);
    fileText += sectionText;
    //whether sentences need to start capitalized
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_SENTENCES_MUST_START_CAPITALIZED, GetSentenceStartMustBeUppercased(), 2);
    fileText += sectionText;
    //file path to phrases to exclude from analysis
    ...
    fileText += sectionText;
    //whether to ignore proper nouns
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_IGNORE_PROPER_NOUNS, IsIgnoringProperNouns(), 2);
    fileText += sectionText;
    //whether to ignore numerals
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_IGNORE_NUMERALS, IsIgnoringNumerals(), 2);
    fileText += sectionText;
    //whether to ignore file addresses
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_IGNORE_FILE_ADDRESSES, IsIgnoringFileAddresses(), 2);
    fileText += sectionText;
    //whether to ignore trailing citations
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_IGNORE_CITATIONS, IsIgnoringTrailingCitations(), 2);
    fileText += sectionText;
    //whether to use aggressive list deduction
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_AGGRESSIVE_EXCLUSION, IsExcludingAggressively(), 2);
    fileText += sectionText;
    //whether to ignore trailing copyright notices
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_IGNORE_COPYRIGHT_NOTICES, IsIgnoringTrailingCopyrightNoticeParagraphs(), 2);
    fileText += sectionText;
    //paragraph parsing
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_PARAGRAPH_PARSING_METHOD, static_cast<int>(GetParagraphsParsingMethod()), 2);
    fileText += sectionText;
    //Number of words that will make an incomplete sentence actually complete
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INCLUDE_INCOMPLETE_SENTENCES_LONGER_THAN, GetIncludeIncompleteSentencesIfLongerThanValue(), 2);
    fileText += sectionText;
    ...
    for(std::vector<CustomReadabilityTestInterface>::const_iterator pos = GetCustTestsInUse().begin();
        ...
        fileText += sectionText;
        //file path
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_FAMILIAR_WORD_FILE_PATH, wxString(pos->GetIterator()->get_familiar_word_list_file_path().c_str()), 3);
        fileText += sectionText;
        //test type
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_TEST_TYPE, static_cast<int>(pos->GetIterator()->get_test_type()), 3);
        fileText += sectionText;
        //stemming type
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_STEMMING_TYPE, static_cast<int>(pos->GetIterator()->get_stemming_type()), 3);
        fileText += sectionText;
        //formula
        ...
        const int formulaType = (wxString(pos->GetIterator()->get_formula().c_str()).CmpNoCase(ReadabilityFormulaParser::GetCustomSpacheSignature()) == 0) ? 1 : 0;
        ...
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INCLUDE_PROPER_NOUNS, static_cast<int>(pos->GetIterator()->get_proper_noun_method()), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INCLUDE_NUMERIC, int_to_bool(pos->GetIterator()->is_including_numeric_as_familiar()), 3);
        fileText += sectionText;
        //include of other tests
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INCLUDE_CUSTOM_WORD_LIST, int_to_bool(pos->GetIterator()->is_including_custom_familiar_word_list()), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INCLUDE_DC_LIST, int_to_bool(pos->GetIterator()->is_including_dale_chall_list()), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INCLUDE_SPACHE_LIST, int_to_bool(pos->GetIterator()->is_including_spache_list()), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INCLUDE_HARRIS_JACOBSON_LIST, int_to_bool(pos->GetIterator()->is_including_harris_jacobson_list()), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INCLUDE_STOCKER_LIST, int_to_bool(pos->GetIterator()->is_including_stocker_list()), 3);
        fileText += sectionText;
        //whether familiar words have to be on each included list
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_FAMILIAR_WORDS_ALL_LISTS, int_to_bool(pos->GetIterator()->is_familiar_words_must_be_on_each_included_list()), 3);
        fileText += sectionText;
        ...
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INDUSTRY_ADULTPUBLISHING, int_to_bool(pos->GetIterator()->has_industry_classification(readability::industry_classification::adult_publishing_industry)), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INDUSTRY_SECONDARY_LANGUAGE, int_to_bool(pos->GetIterator()->has_industry_classification(readability::industry_classification::sedondary_language_industry)), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INDUSTRY_CHILDRENS_HEALTHCARE, int_to_bool(pos->GetIterator()->has_industry_classification(readability::industry_classification::childrens_healthcare_industry)), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INDUSTRY_ADULT_HEALTHCARE, int_to_bool(pos->GetIterator()->has_industry_classification(readability::industry_classification::adult_healthcare_industry)), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INDUSTRY_MILITARY_GOVERNMENT, int_to_bool(pos->GetIterator()->has_industry_classification(readability::industry_classification::military_government_industry)), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_INDUSTRY_BROADCASTING, int_to_bool(pos->GetIterator()->has_industry_classification(readability::industry_classification::broadcasting_industry)), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_DOCUMENT_GENERAL, int_to_bool(pos->GetIterator()->has_document_classification(readability::document_classification::general_document)), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_DOCUMENT_TECHNICAL, int_to_bool(pos->GetIterator()->has_document_classification(readability::document_classification::technical_document)), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_DOCUMENT_FORM, int_to_bool(pos->GetIterator()->has_document_classification(readability::document_classification::nonnarrative_document)), 3);
        fileText += sectionText;
        XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_DOCUMENT_YOUNGADULT, int_to_bool(pos->GetIterator()->has_document_classification(readability::document_classification::adult_literature_document)), 3);
        fileText += sectionText;
    ...
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_GRAPH_PLOT_BACKGROUND_OPACITY, static_cast<int>(GetGraphPlotBackGroundOpacity()), 2);
    fileText += sectionText;
    //background linear gradient
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_GRAPH_BACKGROUND_LINEAR_GRADIENT, GetGraphBackGroundLinearGradient(), 2);
    fileText += sectionText;
    //bar stipple
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_GRAPH_STIPPLE_PATH, GetStippleImagePath(), 2);
    fileText += sectionText;
    //whether drop shadows should be shown
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_DISPLAY_DROP_SHADOW, IsDisplayingDropShadows(), 2);
    fileText += sectionText;
    //watermarks
    ...
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_GRAPH_INTERVAL_DISPLAY, static_cast<int>(GetHistogramIntervalDisplay()), 3);
    fileText += sectionText;
    //categorization label display method
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_GRAPH_BINNING_LABEL_DISPLAY, static_cast<int>(GetHistrogramBinLabelDisplay()), 3);
    fileText += sectionText;
    //rounding
    ...
    fileText += sectionText;
    //bar opacity
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_GRAPH_OPACITY, static_cast<int>(GetGraphBarOpacity()), 3);
    fileText += sectionText;
    //bar display labels
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_BAR_DISPLAY_LABELS, static_cast<int>(IsDisplayingBarLabels()), 3);
    fileText += sectionText;
    //bar effect
    ...
    fileText += sectionText;
    //box effect
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_BOX_EFFECT, static_cast<int>(GetGraphBoxEffect()), 3);
    fileText += sectionText;
    //box show all points
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_BOX_PLOT_SHOW_ALL_POINTS, static_cast<int>(IsShowingAllBoxPlotPoints()), 3);
    fileText += sectionText;
    //box connection points
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_BOX_CONNECT_MIDDLE_POINTS, static_cast<int>(IsConnectingBoxPlotMiddlePoints()), 3);
    fileText += sectionText;
    //box display labels
    ...
    fileText += sectionText;
    // stats report
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_STATISTICS_REPORT, GetStatisticsReportInfo().ToString(), 2);
    fileText += sectionText;
    // variance method
    ...
    fileText += sectionText;
    // grade scale/reading age display
    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_READING_AGE_FORMAT, static_cast<int>(GetReadabilityMessageCatalog().GetReadingAgeDisplay()), 2);
    fileText += sectionText;

    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_READABILITY_TEST_GRADE_SCALE_DISPLAY, static_cast<int>(GetReadabilityMessageCatalog().GetGradeScale()), 2);
    fileText += sectionText;

    XmlFormat::FormatSection(sectionText, wxGetApp().GetAppOptions().XML_READABILITY_TEST_GRADE_SCALE_LONG_FORMAT, GetReadabilityMessageCatalog().IsUsingLongGradeScaleFormat(), 2);
    fileText += sectionText;
    // test-specific options
    // Flesch-Kincaid
