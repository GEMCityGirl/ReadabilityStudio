...
namespace Wisteria
    ...
    public:
        ...
        ScorePoint(const double wordStatistic,
                   const double sentenceStatistic) :
            m_wordStatistic(wordStatistic),
            m_sentenceStatistic(sentenceStatistic),
        ...
        void SetScoreInvalid(const bool enable)
            { m_scoreInfo.set(0, enable); }
        ...
        void SetScoreOutOfGradeRange(const bool enable)
            { m_scoreInfo.set(1, enable); }
        ...
        void SetSentencesHard(const bool enable)
            { m_scoreInfo.set(2, enable); }
        ...
        void SetWordsHard(const bool enable)
            { m_scoreInfo.set(3, enable); }
